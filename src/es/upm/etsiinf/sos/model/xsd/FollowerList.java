...
public class FollowerList implements org.apache.axis2.databinding.ADBBean {
  ...
  */
  ...
  /** field for Followers This was an Array! */
  ...
  public void addFollowers(java.lang.String param) {
    ...
    java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localFollowers);
    list.add(param);
    this.localFollowers = (java.lang.String[]) list.toArray(new java.lang.String[list.size()]);
  }
  ...
  public void serialize(
    ...
    if (serializeType) {
      ...
      if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
        ...
        writeAttribute(
            "xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "FollowerList", xmlWriter);
      }
    }
  ...
  public static class Factory {
     ...
     */
    public static FollowerList parse(javax.xml.stream.XMLStreamReader reader)
        throws java.lang.Exception {
      FollowerList object = new FollowerList();
      ...
      try {
        ...
        if (reader.isStartElement()
            && new javax.xml.namespace.QName("http://model.sos.etsiinf.upm.es/xsd", "followers")
          ...
          while (!loopDone1) {
            ...
            if (reader.isEndElement()) {
              ...
              if (new javax.xml.namespace.QName("http://model.sos.etsiinf.upm.es/xsd", "followers")
                  .equals(reader.getName())) {
