...
public class WineList implements org.apache.axis2.databinding.ADBBean {
  ...
  */
  ...
  public void serialize(
    ...
    if (serializeType) {
      ...
      if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
        ...
        writeAttribute(
            "xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "WineList", xmlWriter);
      }
    }
  ...
  public static class Factory {
     ...
     */
    public static WineList parse(javax.xml.stream.XMLStreamReader reader)
        throws java.lang.Exception {
      WineList object = new WineList();
