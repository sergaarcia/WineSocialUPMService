...
public class WineRated implements org.apache.axis2.databinding.ADBBean {
  ...
  */
  ...
  public void setRate(int param) {
    ...
    localRateTracker = param != java.lang.Integer.MIN_VALUE;
  ...
  public void serialize(
    ...
    if (serializeType) {
      ...
      if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
        ...
        writeAttribute(
            "xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "WineRated", xmlWriter);
      }
    }
  ...
  public static class Factory {
     ...
     */
    public static WineRated parse(javax.xml.stream.XMLStreamReader reader)
        throws java.lang.Exception {
      WineRated object = new WineRated();
      ...
      try {
        ...
        if (reader.isStartElement()
            && new javax.xml.namespace.QName("http://model.sos.etsiinf.upm.es/xsd", "grape")
        ...
        if (reader.isStartElement()
            && new javax.xml.namespace.QName("http://model.sos.etsiinf.upm.es/xsd", "rate")
                .equals(reader.getName())) {
          ...
          object.setRate(org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(content));
        ...
        if (reader.isStartElement()
            && new javax.xml.namespace.QName("http://model.sos.etsiinf.upm.es/xsd", "year")
                .equals(reader.getName())) {
